    ...
    <div className="mx-auto max-w-4xl p-6">
      ...
      <div className="p-6 shadow-lg border-black rounded-b-lg">
        ...
        <section className="mt-8">
          ...
          <p className="mt-4 text-lg leading-relaxed">
            Somos un equipo de jugadores apasionados con una amplia experiencia
            en la industria del videojuego. Cada miembro de nuestro equipo
            aporta su propio estilo y perspectiva, asegurando que nuestras
            reseñas sean completas y variadas. Estamos comprometidos a mantener
            la integridad en nuestras opiniones y a proporcionar contenido de
            alta calidad para nuestra comunidad.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p className="mt-4 text-lg leading-relaxed">
            Queremos que Gamer Review sea un espacio donde los jugadores puedan
            conectarse, compartir sus experiencias y descubrir nuevos títulos.
            No dudes en unirte a nosotros en nuestras redes sociales, dejar
            comentarios en nuestras reseñas, o enviarnos tus sugerencias y
            opiniones.
          </p>
        </section>
      </div>
